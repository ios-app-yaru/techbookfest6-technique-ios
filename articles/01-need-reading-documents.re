...
本章では、これからのiOSアプリ開発において、また筆者のこれまでのiOSアプリ開発をしてきた中で読んでおくべきだと@<b>{強く感じた}リファレンスや書物、サイトを紹介していきます。
...
AppleによるUI設計の原則を定めたガイドライン。iOS、macOS、watchOS、tvOSアプリ開発におけるUIの原則や思想等が書かれています。
...
//image[hug-status-bar][ステータスバーの扱い][scale=0.7]{
//}

作ったアプリが「なんかイマイチなUIだな〜、使い心地良くないな〜・・・」と感じるなら、一度見てみましょう。
...
Swiftとはなんぞや？というところから、言語仕様解説、実際の業務でどう使うか？まで解説していて、初心者〜上級者までこれ１冊でいけるといっても過言ではないくらい良い本です。必須。実際、著者（僕）もiOSアプリ開発に入門するときに一番最初に購入していて、今でも時々参照しています。
