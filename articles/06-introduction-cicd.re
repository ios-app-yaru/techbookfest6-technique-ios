...
フリー版だと、直列ビルドでビルド時間にMAX10分等の制限がついているので注意です。

※この本が出版された後に変わる可能性があります。

//image[bitrise-pricing][Bitrise課金携帯]{
//}
...
//image[bitrise-provisioning-profile][Provisioning Profileのアップロード]{
//}

  * CODE SIGNING IDENTITYセクションに.p12ファイルをドラッグしてアップロード

//image[bitrise-codesigning][.p12ファイルのアップロード]{
//}
...
手動で動かす場合は、@<b>{Start/Schedule} ボタンを押してbranchを@<b>{master}にするとワークフローが走ります。
